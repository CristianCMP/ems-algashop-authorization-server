...
public class PublicPasswordController {
    ...
    @GetMapping
    public String passwordForm(@RequestParam(name = "token", required = false) String token, Model model) {
    ...
    public String changePassword(@RequestParam("token") String token, @RequestParam("newPassword") String newPassword, Model model) {
        try {
